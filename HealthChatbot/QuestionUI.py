...
class MainForm(Frame):
    ...
    def createWidget(self):
        ...
        self.lblTeam.pack()
        self.lblTeam1=Label(self, text="Ayush Mishra", bg="white", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam1.pack()
        self.lblTeam2=Label(self, text="Harshita Singh", bg="white", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam2.pack()
        self.lblTeam3=Label(self, text="Vaibhav Gupta", bg="white", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam3.pack()
        self.lblTeam3=Label(self, text="Vansh Sharma", bg="white", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam3.pack()
