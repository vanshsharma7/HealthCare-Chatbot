# import modules
from QuestionDiagonosisTkinter import QuestionDigonosis
from tkinter import *
import os
...
def login_sucess():
    ...
    Button(login_success_screen, text="OK", command=start_diagnosis).pack()
...
def start_diagnosis():
    ...
    diag_root = Tk()
    diag_root.title("Diagnosis Interface")
    QuestionDigonosis(diag_root).pack()
    diag_root.mainloop()
